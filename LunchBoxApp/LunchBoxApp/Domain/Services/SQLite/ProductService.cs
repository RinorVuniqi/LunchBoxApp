...
namespace LunchBoxApp.Domain.Services.SQLite
{
    public class ProductService : SQLiteServiceBase, IProductService
    {
        ...
        private async Task GetJson()
        {
            try
            {
                string url = new Constants().url + "products";
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    Debug.WriteLine("Success! in the if statement");
                }
                else
                {
                    Debug.WriteLine("Fail, else statement");
                }
            }
            ...
            catch (Exception e)
            {
                ...
                Debug.WriteLine("Fail, exception caught");
            }
